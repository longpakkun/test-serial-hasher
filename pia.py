...
def start():
  ...
  #load images
  cue_image = pygame.image.load("\\\\10.177.113.250\\data$\\Happy\\python\\assets\\images\\cue.png").convert_alpha()
  table_image = pygame.image.load("\\\\10.177.113.250\\data$\\Happy\\python\\assets\\images\\table.png").convert_alpha()
  ball_images = []
  for i in range(1, 17):
    ball_image = pygame.image.load(f"\\\\10.177.113.250\data$\Happy\python\\assets\\images\\ball_{i}.png").convert_alpha()
